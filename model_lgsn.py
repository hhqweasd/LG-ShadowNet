...
class Generator_S2F(nn.Module):
    ...
    def from_file(file_path: str) -> nn.Module:
        print('Initializes a new b weights of S2F with existing L weights...')
    ...
    def forward(self,xin,xinl):
        ...
        '''
        slabimage480_realsr = x3_L[0].data
        ...
        slabimage480_realsr=resize(slabimage480_realsr,(112,112,1))
        io.imsave('./model_istda_llab_lab_light_e100_l150_multi_3_shallow_wi_Lpretrain_colour/x3_L.png',slabimage480_realsr)
        
        slabimage480_realsr = x3[0].data
        #slabimage480_realsr=(slabimage480_realsr+1.0)/2.0
        slabimage480_realsr=slabimage480_realsr.data.squeeze(0).cpu()
        slabimage480_realsr=slabimage480_realsr.transpose(0, 2).transpose(0, 1).contiguous().numpy()
        slabimage480_realsr=resize(slabimage480_realsr,(112,112,1))
        io.imsave('./model_istda_llab_lab_light_e100_l150_multi_3_shallow_wi_Lpretrain_colour/x3.png',slabimage480_realsr)
        
        slabimage480_realsr = torch.mul(x3,x3_L)[0].data
        #slabimage480_realsr=(slabimage480_realsr+1.0)/2.0
        slabimage480_realsr=slabimage480_realsr.data.squeeze(0).cpu()
        slabimage480_realsr=slabimage480_realsr.transpose(0, 2).transpose(0, 1).contiguous().numpy()
        slabimage480_realsr=resize(slabimage480_realsr,(112,112,1))
        io.imsave('./model_istda_llab_lab_light_e100_l150_multi_3_shallow_wi_Lpretrain_colour/x3m.png',slabimage480_realsr)
        exit(0)
        '''
